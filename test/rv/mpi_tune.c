...
// LOOP A is a wrapper of this function (i.e., for all ranks needed to be tune 
    ...
    if (my_rank == root_rank)
    {
        ...
        //
	if ( (TrueTuneNotSearch) || ((int)*ptr_i_accumul>RestoreTrueTune) )
	{
	...
	*/
	...
	if (TuneAndJump)
	    ...
	    //
	    if (logpost_all_ranks[rank_in_tune] < bestPosition_Logpost_NParmTuned[bestPosition_i][N_parm])
	    {
	        doJump = 1;
	    }
