...
//////////////////////////////
// TEST RESULTS ONLY
double bplanck(double T, double nv);
...
/*
// TEST RESULTS ONLY
double * fitted_para_array;
fitted_para_array = alloc_1d_double(N_parm);
fitted_para_array[0] = 1461.10 ;
fitted_para_array[1] = 286.75 ;
fitted_para_array[2] = 0.96;
fitted_para_array[3] = -2.99;
fitted_para_array[4] = -8.79;
fitted_para_array[5] = -2.31;
fitted_para_array[6] = -4.63;
fitted_para_array[7] = -8.43;
fitted_para_array[8] = -2.65;
fitted_para_array[9] = -7.54;
fitted_para_array[10] = -8.9;
fitted_para_array[11] = -8.77;
fitted_para_array[12] = -8.74;
fitted_para_array[13] = -6.6;
fitted_para_array[14] = -8.42;
double logll_fit_mean;
logll_fit_mean = logll_beta(fitted_para_array, nline_data, data_NlineNdim, 1.0);
printf("Best fit logll value: %lf\n", logll_fit_mean);
*/
//////////////////////////////
//////////////////////////////
